...
} elseif ($_instance->childHasBeenRendered('wlWjZ22')) {
    $componentId = $_instance->getRenderedChildComponentId('wlWjZ22');
    $componentTag = $_instance->getRenderedChildComponentTagName('wlWjZ22');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wlWjZ22');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('wlWjZ22', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\xampp\htdocs\app\resources\views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>