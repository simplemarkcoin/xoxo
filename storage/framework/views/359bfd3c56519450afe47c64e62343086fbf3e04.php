...
} elseif ($_instance->childHasBeenRendered('OtdFLAd')) {
    $componentId = $_instance->getRenderedChildComponentId('OtdFLAd');
    $componentTag = $_instance->getRenderedChildComponentTagName('OtdFLAd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OtdFLAd');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('OtdFLAd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
