                            ...
                            <div class="mb-4">
                                <select class="form-select" required name="country" id="country">
                                    ...
                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(strtolower(trim($value)) == $userCountry ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
...
</script><?php /**PATH C:\xampp\htdocs\app\resources\views\profile\update-profile-information-form.blade.php ENDPATH**/ ?>