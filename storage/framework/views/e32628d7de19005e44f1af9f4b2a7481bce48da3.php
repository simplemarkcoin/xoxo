...
} elseif ($_instance->childHasBeenRendered('4icSLIA')) {
    $componentId = $_instance->getRenderedChildComponentId('4icSLIA');
    $componentTag = $_instance->getRenderedChildComponentTagName('4icSLIA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4icSLIA');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('4icSLIA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views\user\payment.blade.php ENDPATH**/ ?>