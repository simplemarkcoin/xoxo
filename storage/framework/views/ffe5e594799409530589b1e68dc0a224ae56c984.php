...
} elseif ($_instance->childHasBeenRendered('H3AV3EB')) {
    $componentId = $_instance->getRenderedChildComponentId('H3AV3EB');
    $componentTag = $_instance->getRenderedChildComponentTagName('H3AV3EB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('H3AV3EB');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('H3AV3EB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\xampp\htdocs\app\resources\views\admin\Settings\AppSettings\theme.blade.php ENDPATH**/ ?>