...
} elseif ($_instance->childHasBeenRendered('iZCkCE8')) {
    $componentId = $_instance->getRenderedChildComponentId('iZCkCE8');
    $componentTag = $_instance->getRenderedChildComponentTagName('iZCkCE8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iZCkCE8');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('iZCkCE8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
                                <form action="<?php echo e(route('taxverification')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views\user\withdraw.blade.php ENDPATH**/ ?>