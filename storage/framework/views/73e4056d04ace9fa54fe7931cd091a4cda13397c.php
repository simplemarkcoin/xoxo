...
<head>
    ...
    <meta name="description" content="<?php echo e($settings->site_name); ?> is one of the world's leading forex,stock and crypto trading platform ">
    

    <!-- ========== Page Title ========== -->
    <title><?php echo e($settings->site_name); ?> is one of the world's leading forex,stock and crypto trading platform </title>

    <!-- ========== Favicon Icon ========== -->
    <link rel="shortcut icon" href="<?php echo e(asset('storage/app/public/photos/'.$settings->favicon)); ?>" type="image/x-icon">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/">
                        <img src="<?php echo e(asset('storage/app/public/' . $settings->logo)); ?>" class="logo logo-display" class="w-50" alt="Logo" width="250" height="600">
                        <img src="<?php echo e(asset('storage/app/public/' . $settings->logo)); ?>" class="logo logo-scrolled" class="w-50" alt="Logo" width="250" height="600">
                    </a>
                </div>
                        ...
                        <div class="f-item twitter-widget">
                            ...
                            <div class="twitter-item">
                                <div class="twitter-content">
                                    <p>
                                  <i class="fas fa-map"></i> <?php echo e($settings->office); ?></p>
                                </div>
                            ...
                            <div class="twitter-item">
                                <div class="twitter-content">
                                    <p>
                                    <i class="fas fa-envelope-open"></i> <?php echo e($settings->contact_email); ?></p>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\app\resources\views\layouts\base1.blade.php ENDPATH**/ ?>