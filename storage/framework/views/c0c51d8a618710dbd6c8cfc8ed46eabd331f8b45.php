...
<article class="main-layout__content">
            ...
            <section class="page-intro page-intro-investments">
              <div class="container container-large"> 
                <h1 class="page-intro__title">RELIABLE INVESTMENT WITH <?php echo e($settings->site_name); ?><br></h1><br><br>
	...
	text-align: center;
                ...
                <h1 class="page-intro__title" id="class"style="color: #fff;	font-size: 20px;"><?php echo e($settings->site_name); ?> MARKETING PLAN</h1>
                  <div class="typography"> 
                    <p><?php echo e($settings->site_name); ?> developers have created a unique cryptocurrency robot. It predicts the value of Bitcoin while generating daily profit on trades. The <?php echo e($settings->site_name); ?> robot is able to benefit at any stage of the market: both growth and decline.</p>
<p><?php echo e($settings->site_name); ?> CFO has developed a unique marketing plan for the platform to function fully. The Investors of our company have an excellent opportunity to receive financial benefits on stable terms. You can also use the profitability calculator. It will calculate the exact return on your investment.</p>
                  </div>
                </div>
              </div>
            </section>
              ...
              <div class="container container-large">
                <div class="section-intro"> 
                  ...
                  <div class="section-intro__description"> 
                    <p style="margin-top: -20px;"><?php echo e($settings->site_name); ?> employees ensure that every investor in our company can earn money</p>
                  </div>
                </div>
                          ...
                          <div class="deposits-item__content">
                            <div class="deposits-item__count"style="margin: 0;"> 
                              ...
                              <div class="deposits-item__count-content"> 
                                ...
                                <p class="deposits-item__count-desc"><?php echo e($plan->name); ?>                                </p>
                              </div>
                            </div>
                    ...
                    <div class="deposits__col-sidebar"> 
                      <div class="limits-warning"> 
                        ...
                        <div class="limits-warning__content">
                          <p>These commissions are charged by <?php echo e($settings->site_name); ?> for the platform to work. They are not related to the profit received by our investors</p>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="typography"> 
                          <ul>
                            <li> 
                              ...
                              <p><span class="color-primary">0.5%</span> from the received profit by the robot. This commission shows the earnings of the entire <?php echo e($settings->site_name); ?> structure, namely, each employee.</p>
                            </li>
                            <li> 
...
.steps .steps-item {text-align: center;
                    ...
                    <div class="swiper-slide">
                      <div class="steps-item"> 
                        ...
                        <div class="steps-item__description"> 
                          <p>Click the Register button. Fill in your details to create a FREE <?php echo e($settings->site_name); ?> account in seconds</p>
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide">
            ...
            <section class="text-columns">
              <div class="container">
                ...
                <div class="typography"> 
                  <p>UNIQUE TRADING ROBOT FOR TRADING<?php echo e($settings->site_name); ?> robot is a unique trading tool for getting profit at the stages of growth and fall of the cryptocurrency market. Operations are managed without user intervention. The work of the robot is fully automated and cannot include usage errors. The robot generates the Bitcoin exchange rate, thereby benefiting the company. The main condition for cooperation with <?php echo e($settings->site_name); ?> is the availability of an active deposit to obtain an investment profit in the future.</p>
                </div>
              </div>
            </section>
            ...
            <section class="funds">
              <div class="container">
                <div class="section-intro"> 
                  <h3 class="title">BEST <?php echo e($settings->site_name); ?> TRADERS</h3>
                  <div class="section-intro__description"> 
                    <p>The best cryptocurrency developers works in our company. They have a wealth of experience and understanding of the crypto market behind them. They brought <?php echo e($settings->site_name); ?> to the world level of development</p>
                  </div>
                </div>
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="funds-item"> 
                        ...
                        <div class="funds-item__description"> 
                          <p><?php echo e($settings->site_name); ?> team of professionals has created a unique trading robot that makes profit at any stage of the market: rise or fall</p>
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide">
                    ...
                    <div class="swiper-slide">
                      <div class="funds-item"> 
                        ...
                        <div class="funds-item__description"> 
                          <p>The highly professional <?php echo e($settings->site_name); ?> team controls all the processes of the trading robot around the clock. After investing, you will observe the growth of your capital in real time</p>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="payments__col">
                        <div class="payments__content">
                          <div class="section-intro"> 
                            ...
                            <div class="section-intro__description"> 
                              <p><?php echo e($settings->site_name); ?> supports a big number of payment systems</p>
                            </div>
                          </div>
                          <div class="typography"> 
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views\home\investment.blade.php ENDPATH**/ ?>